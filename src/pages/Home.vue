<template>
  <h1>Senior designer creating clear, robust, consistent, elegant solutions that avoid redundancy. Currently working on a better employee experience at
    <a href="https://en.wikipedia.org/wiki/Kuehne_%2B_Nagel">Kuehne&nbsp;+&nbsp;Nagel</a>.
    <!-- Before that... -->
    <!-- clear; robust; ... -->
  </h1>
  <section id="work">
      ...
      <router-link to="/formbuilder" class="card-link">
        <figure>
          <img
            ...
            width="800"
            height ="410"
            src="../assets/images/home/formbuilder.png"
